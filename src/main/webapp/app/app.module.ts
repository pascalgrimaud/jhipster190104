...
@NgModule({
    imports: [
        ...
        Ng2Webstorage.forRoot({ prefix: 'my-prefix', separator: '-' }),
    ...
    declarations: [MyPrefixMainComponent, NavbarComponent, ErrorComponent, PageRibbonComponent, ActiveMenuDirective, FooterComponent],
    providers: [
        {
    ...
    bootstrap: [MyPrefixMainComponent]
})
