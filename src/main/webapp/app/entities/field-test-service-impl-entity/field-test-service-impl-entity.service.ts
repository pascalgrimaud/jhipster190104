...
export class FieldTestServiceImplEntityService {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredMika =
                res.body.zonedDateTimeRequiredMika != null ? moment(res.body.zonedDateTimeRequiredMika) : null;
        }
        return res;
    }
        ...
        if (res.body) {
            res.body.forEach((fieldTestServiceImplEntity: IFieldTestServiceImplEntity) => {
                ...
                fieldTestServiceImplEntity.localDateRequiredMika =
                    fieldTestServiceImplEntity.localDateRequiredMika != null
                        ? moment(fieldTestServiceImplEntity.localDateRequiredMika)
                        : null;
                ...
                fieldTestServiceImplEntity.instanteRequiredMika =
                    fieldTestServiceImplEntity.instanteRequiredMika != null
                        ? moment(fieldTestServiceImplEntity.instanteRequiredMika)
                        : null;
