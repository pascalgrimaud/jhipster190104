...
@Component({
    selector: 'my-prefix-entity-with-service-impl-pagination-and-dto-update',
...
export class EntityWithServiceImplPaginationAndDTOUpdateComponent implements OnInit {
    ...
    protected subscribeToSaveResponse(result: Observable<HttpResponse<IEntityWithServiceImplPaginationAndDTO>>) {
        result.subscribe(
