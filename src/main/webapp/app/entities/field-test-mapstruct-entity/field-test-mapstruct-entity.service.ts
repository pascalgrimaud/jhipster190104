...
export class FieldTestMapstructEntityService {
    public resourceUrl = SERVER_API_URL + 'api/field-test-mapstruct-entities';
    ...
    protected convertDateFromClient(fieldTestMapstructEntity: IFieldTestMapstructEntity): IFieldTestMapstructEntity {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredEva =
                res.body.zonedDateTimeRequiredEva != null ? moment(res.body.zonedDateTimeRequiredEva) : null;
        }
        return res;
    }
