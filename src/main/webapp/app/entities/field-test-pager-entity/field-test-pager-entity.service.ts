...
export class FieldTestPagerEntityService {
    public resourceUrl = SERVER_API_URL + 'api/field-test-pager-entities';
    ...
    protected convertDateFromClient(fieldTestPagerEntity: IFieldTestPagerEntity): IFieldTestPagerEntity {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredJade =
                res.body.zonedDateTimeRequiredJade != null ? moment(res.body.zonedDateTimeRequiredJade) : null;
        }
        return res;
    }
    ...
    protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        if (res.body) {
            res.body.forEach((fieldTestPagerEntity: IFieldTestPagerEntity) => {
                ...
                fieldTestPagerEntity.instantJade =
                    fieldTestPagerEntity.instantJade != null ? moment(fieldTestPagerEntity.instantJade) : null;
