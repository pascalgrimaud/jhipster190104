...
export class FieldTestEntityService {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredTom =
                res.body.zonedDateTimeRequiredTom != null ? moment(res.body.zonedDateTimeRequiredTom) : null;
        }
        return res;
    }
        ...
        if (res.body) {
            res.body.forEach((fieldTestEntity: IFieldTestEntity) => {
                ...
                fieldTestEntity.zonedDateTimeTom =
                    fieldTestEntity.zonedDateTimeTom != null ? moment(fieldTestEntity.zonedDateTimeTom) : null;
