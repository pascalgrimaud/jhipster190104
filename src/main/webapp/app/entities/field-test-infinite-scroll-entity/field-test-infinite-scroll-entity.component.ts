...
@Component({
    selector: 'my-prefix-field-test-infinite-scroll-entity',
...
export class FieldTestInfiniteScrollEntityComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: IFieldTestInfiniteScrollEntity) {
        return item.id;
    }
    ...
    protected paginateFieldTestInfiniteScrollEntities(data: IFieldTestInfiniteScrollEntity[], headers: HttpHeaders) {
