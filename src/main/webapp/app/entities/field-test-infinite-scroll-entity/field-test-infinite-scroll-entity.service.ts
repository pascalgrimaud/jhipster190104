...
export class FieldTestInfiniteScrollEntityService {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredHugo =
                res.body.zonedDateTimeRequiredHugo != null ? moment(res.body.zonedDateTimeRequiredHugo) : null;
        }
        return res;
    }
        ...
        if (res.body) {
            res.body.forEach((fieldTestInfiniteScrollEntity: IFieldTestInfiniteScrollEntity) => {
                ...
                fieldTestInfiniteScrollEntity.zonedDateTimeHugo =
                    fieldTestInfiniteScrollEntity.zonedDateTimeHugo != null
                        ? moment(fieldTestInfiniteScrollEntity.zonedDateTimeHugo)
                        : null;
