...
export class FieldTestServiceClassEntityService {
    public resourceUrl = SERVER_API_URL + 'api/field-test-service-class-entities';
    ...
    protected convertDateFromClient(fieldTestServiceClassEntity: IFieldTestServiceClassEntity): IFieldTestServiceClassEntity {
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            ...
            res.body.zonedDateTimeRequiredBob =
                res.body.zonedDateTimeRequiredBob != null ? moment(res.body.zonedDateTimeRequiredBob) : null;
        }
        return res;
    }
        ...
        if (res.body) {
            res.body.forEach((fieldTestServiceClassEntity: IFieldTestServiceClassEntity) => {
                ...
                fieldTestServiceClassEntity.localDateRequiredBob =
                    fieldTestServiceClassEntity.localDateRequiredBob != null
                        ? moment(fieldTestServiceClassEntity.localDateRequiredBob)
                        : null;
                ...
                fieldTestServiceClassEntity.instanteRequiredBob =
                    fieldTestServiceClassEntity.instanteRequiredBob != null
                        ? moment(fieldTestServiceClassEntity.instanteRequiredBob)
                        : null;
