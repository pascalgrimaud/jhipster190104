...
export class FieldTestEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-entity div h2#page-heading span')).first();
...
export class FieldTestEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-entity-heading'));
...
export class FieldTestEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestEntity-heading'));
