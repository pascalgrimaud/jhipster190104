...
describe('EntityWithServiceClass e2e test', () => {
    ...
    it('should load EntityWithServiceClasses', async () => {
        ...
        expect(await entityWithServiceClassComponentsPage.getTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClass.home.title'
        );
    });
    ...
    it('should load create EntityWithServiceClass page', async () => {
        ...
        expect(await entityWithServiceClassUpdatePage.getPageTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClass.home.createOrEditLabel'
        );
    ...
    it('should create and save EntityWithServiceClasses', async () => {
        ...
        await entityWithServiceClassComponentsPage.clickOnCreateButton();
        await promise.all([entityWithServiceClassUpdatePage.setZoeInput('zoe')]);
    ...
    it('should delete last EntityWithServiceClass', async () => {
        ...
        expect(await entityWithServiceClassDeleteDialog.getDialogTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClass.delete.question'
        );
