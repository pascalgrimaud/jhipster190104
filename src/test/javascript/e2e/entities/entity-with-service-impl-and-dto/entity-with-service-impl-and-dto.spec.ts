...
describe('EntityWithServiceImplAndDTO e2e test', () => {
    ...
    it('should load EntityWithServiceImplAndDTOS', async () => {
        ...
        expect(await entityWithServiceImplAndDTOComponentsPage.getTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceImplAndDTO.home.title'
        );
    });
    ...
    it('should load create EntityWithServiceImplAndDTO page', async () => {
        ...
        expect(await entityWithServiceImplAndDTOUpdatePage.getPageTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceImplAndDTO.home.createOrEditLabel'
        );
    ...
    it('should create and save EntityWithServiceImplAndDTOS', async () => {
        ...
        await entityWithServiceImplAndDTOComponentsPage.clickOnCreateButton();
        await promise.all([entityWithServiceImplAndDTOUpdatePage.setLouisInput('louis')]);
    ...
    it('should delete last EntityWithServiceImplAndDTO', async () => {
        ...
        expect(await entityWithServiceImplAndDTODeleteDialog.getDialogTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceImplAndDTO.delete.question'
        );
