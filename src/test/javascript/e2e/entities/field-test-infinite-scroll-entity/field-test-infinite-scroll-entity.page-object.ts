...
export class FieldTestInfiniteScrollEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-infinite-scroll-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-infinite-scroll-entity div h2#page-heading span')).first();
...
export class FieldTestInfiniteScrollEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-infinite-scroll-entity-heading'));
...
export class FieldTestInfiniteScrollEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestInfiniteScrollEntity-heading'));
