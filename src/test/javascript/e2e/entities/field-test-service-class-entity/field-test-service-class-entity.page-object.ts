...
export class FieldTestServiceClassEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-service-class-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-service-class-entity div h2#page-heading span')).first();
...
export class FieldTestServiceClassEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-service-class-entity-heading'));
...
export class FieldTestServiceClassEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestServiceClassEntity-heading'));
