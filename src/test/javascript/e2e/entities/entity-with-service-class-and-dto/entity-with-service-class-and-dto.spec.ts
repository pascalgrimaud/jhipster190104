...
describe('EntityWithServiceClassAndDTO e2e test', () => {
    ...
    it('should load EntityWithServiceClassAndDTOS', async () => {
        ...
        expect(await entityWithServiceClassAndDTOComponentsPage.getTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClassAndDTO.home.title'
        );
    });
    ...
    it('should load create EntityWithServiceClassAndDTO page', async () => {
        ...
        expect(await entityWithServiceClassAndDTOUpdatePage.getPageTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClassAndDTO.home.createOrEditLabel'
        );
    ...
    it('should create and save EntityWithServiceClassAndDTOS', async () => {
        ...
        await entityWithServiceClassAndDTOComponentsPage.clickOnCreateButton();
        await promise.all([entityWithServiceClassAndDTOUpdatePage.setLucasInput('lucas')]);
    ...
    it('should delete last EntityWithServiceClassAndDTO', async () => {
        ...
        expect(await entityWithServiceClassAndDTODeleteDialog.getDialogTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithServiceClassAndDTO.delete.question'
        );
