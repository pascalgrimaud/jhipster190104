...
export class FieldTestMapstructEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-mapstruct-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-mapstruct-entity div h2#page-heading span')).first();
...
export class FieldTestMapstructEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-mapstruct-entity-heading'));
...
export class FieldTestMapstructEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestMapstructEntity-heading'));
