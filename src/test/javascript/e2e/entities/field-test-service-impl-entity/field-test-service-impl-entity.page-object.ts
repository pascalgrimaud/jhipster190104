...
export class FieldTestServiceImplEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-service-impl-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-service-impl-entity div h2#page-heading span')).first();
...
export class FieldTestServiceImplEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-service-impl-entity-heading'));
...
export class FieldTestServiceImplEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestServiceImplEntity-heading'));
