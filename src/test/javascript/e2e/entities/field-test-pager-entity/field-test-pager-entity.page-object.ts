...
export class FieldTestPagerEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-pager-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-pager-entity div h2#page-heading span')).first();
...
export class FieldTestPagerEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-pager-entity-heading'));
...
export class FieldTestPagerEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestPagerEntity-heading'));
