...
export class FieldTestPaginationEntityComponentsPage {
    ...
    deleteButtons = element.all(by.css('my-prefix-field-test-pagination-entity div table .btn-danger'));
    title = element.all(by.css('my-prefix-field-test-pagination-entity div h2#page-heading span')).first();
...
export class FieldTestPaginationEntityUpdatePage {
    pageTitle = element(by.id('my-prefix-field-test-pagination-entity-heading'));
...
export class FieldTestPaginationEntityDeleteDialog {
    private dialogTitle = element(by.id('my-prefix-delete-fieldTestPaginationEntity-heading'));
