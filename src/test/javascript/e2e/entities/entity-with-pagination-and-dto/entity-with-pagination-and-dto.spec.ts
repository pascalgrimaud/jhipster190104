...
describe('EntityWithPaginationAndDTO e2e test', () => {
    ...
    it('should load EntityWithPaginationAndDTOS', async () => {
        ...
        expect(await entityWithPaginationAndDTOComponentsPage.getTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithPaginationAndDTO.home.title'
        );
    });
    ...
    it('should load create EntityWithPaginationAndDTO page', async () => {
        ...
        expect(await entityWithPaginationAndDTOUpdatePage.getPageTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithPaginationAndDTO.home.createOrEditLabel'
        );
    ...
    it('should create and save EntityWithPaginationAndDTOS', async () => {
        ...
        await entityWithPaginationAndDTOComponentsPage.clickOnCreateButton();
        await promise.all([entityWithPaginationAndDTOUpdatePage.setLeaInput('lea')]);
    ...
    it('should delete last EntityWithPaginationAndDTO', async () => {
        ...
        expect(await entityWithPaginationAndDTODeleteDialog.getDialogTitle()).to.eq(
            'jhipsterSampleApplicationApp.entityWithPaginationAndDTO.delete.question'
        );
