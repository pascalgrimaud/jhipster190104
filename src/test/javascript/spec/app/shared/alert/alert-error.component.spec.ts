...
import { MyPrefixAlertErrorComponent } from 'app/shared/alert/alert-error.component';
import { MockAlertService } from '../../../helpers/mock-alert.service';

describe('Component Tests', () => {
    describe('Alert Error Component', () => {
        let comp: MyPrefixAlertErrorComponent;
        let fixture: ComponentFixture<MyPrefixAlertErrorComponent>;
        let eventManager: JhiEventManager;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterSampleApplicationTestModule, TranslateModule.forRoot()],
                declarations: [MyPrefixAlertErrorComponent],
                providers: [
                    JhiEventManager,
                    {
                ...
                .overrideTemplate(MyPrefixAlertErrorComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MyPrefixAlertErrorComponent);
