...
import { MyPrefixLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: MyPrefixLoginModalComponent;
        let fixture: ComponentFixture<MyPrefixLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MyPrefixLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MyPrefixLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MyPrefixLoginModalComponent);
