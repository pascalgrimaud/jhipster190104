...
import { MyPrefixHealthCheckComponent } from 'app/admin/health/health.component';
import { MyPrefixHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('MyPrefixHealthCheckComponent', () => {
        let comp: MyPrefixHealthCheckComponent;
        let fixture: ComponentFixture<MyPrefixHealthCheckComponent>;
        let service: MyPrefixHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterSampleApplicationTestModule],
                declarations: [MyPrefixHealthCheckComponent]
            })
                .overrideTemplate(MyPrefixHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MyPrefixHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(MyPrefixHealthService);
        });
