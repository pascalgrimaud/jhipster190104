...
} from 'app/shared/model/entity-with-service-impl-pagination-and-dto.model';
...
describe('Service Tests', () => {
    describe('EntityWithServiceImplPaginationAndDTO Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new EntityWithServiceImplPaginationAndDTO(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EntityWithServiceImplPaginationAndDTO', async () => {
                ...
                service
                    .create(new EntityWithServiceImplPaginationAndDTO(null))
                    .pipe(take(1))
            ...
            it('should update a EntityWithServiceImplPaginationAndDTO', async () => {
                const returnedFromService = Object.assign(
                    {
                        theo: 'BBBBBB'
                    },
            ...
            it('should return a list of EntityWithServiceImplPaginationAndDTO', async () => {
                const returnedFromService = Object.assign(
                    {
                        theo: 'BBBBBB'
                    },
            ...
            it('should delete a EntityWithServiceImplPaginationAndDTO', async () => {
