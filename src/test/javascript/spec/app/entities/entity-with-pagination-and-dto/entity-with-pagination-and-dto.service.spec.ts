...
import { IEntityWithPaginationAndDTO, EntityWithPaginationAndDTO } from 'app/shared/model/entity-with-pagination-and-dto.model';
...
describe('Service Tests', () => {
    describe('EntityWithPaginationAndDTO Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EntityWithPaginationAndDTOService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EntityWithPaginationAndDTO', async () => {
                ...
                service
                    .create(new EntityWithPaginationAndDTO(null))
                    .pipe(take(1))
