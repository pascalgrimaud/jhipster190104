...
import { IEntityWithServiceImplAndDTO, EntityWithServiceImplAndDTO } from 'app/shared/model/entity-with-service-impl-and-dto.model';
...
describe('Service Tests', () => {
    describe('EntityWithServiceImplAndDTO Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EntityWithServiceImplAndDTOService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EntityWithServiceImplAndDTO', async () => {
                ...
                service
                    .create(new EntityWithServiceImplAndDTO(null))
                    .pipe(take(1))
