...
import { IEntityWithServiceClassAndDTO, EntityWithServiceClassAndDTO } from 'app/shared/model/entity-with-service-class-and-dto.model';
...
describe('Service Tests', () => {
    describe('EntityWithServiceClassAndDTO Service', () => {
        ...
        let elemDefault: IEntityWithServiceClassAndDTO;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(EntityWithServiceClassAndDTOService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EntityWithServiceClassAndDTO', async () => {
                ...
                service
                    .create(new EntityWithServiceClassAndDTO(null))
                    .pipe(take(1))
