...
} from 'app/shared/model/entity-with-service-class-pagination-and-dto.model';
...
describe('Service Tests', () => {
    describe('EntityWithServiceClassPaginationAndDTO Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new EntityWithServiceClassPaginationAndDTO(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EntityWithServiceClassPaginationAndDTO', async () => {
                ...
                service
                    .create(new EntityWithServiceClassPaginationAndDTO(null))
                    .pipe(take(1))
            ...
            it('should update a EntityWithServiceClassPaginationAndDTO', async () => {
                const returnedFromService = Object.assign(
                    {
                        lena: 'BBBBBB'
                    },
            ...
            it('should return a list of EntityWithServiceClassPaginationAndDTO', async () => {
                const returnedFromService = Object.assign(
                    {
                        lena: 'BBBBBB'
                    },
            ...
            it('should delete a EntityWithServiceClassPaginationAndDTO', async () => {
